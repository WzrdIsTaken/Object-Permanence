...
// Credit - Bly7 (https://github.com/Bly7/OBJ-Loader/blob/master/Source/OBJ_Loader.h)

// Notes:
// - Made the math/algorithm functions inline to stop LNK2005
// - Disabled the warnings (see below)
// - Replaced cout with nabi's log and enabled OBJL_CONSOLE_OUTPUT in debug mode

// Possible todos:
// - Replace the vector with DirectX vector?
...
#pragma warning( push )
#pragma warning( disable : 4244 ) // 'argument' : conversion from 'type1' to 'type2', possible loss of data (959)
#pragma warning( disable : 4018 ) // 'token' : signed/unsigned mismatch (662, 699, 705)
